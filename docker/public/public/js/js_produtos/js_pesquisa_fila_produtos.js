	        ...
	        $.ajax({    
	                ...
	                success:function(results){
				        ...
				        $.each(results.lista, function() {
							...
							if(this.processado==1){
								var procesado = 'Processado';
							}else{
								var procesado = 'Pendente';
							}


				            $("#listagem_dados").append("<tr>"+
				                                            "<td>"+this.string_linha_arquivo+"</td>"+
                                                            "<td>"+this.log_importacao+"</td>"+
