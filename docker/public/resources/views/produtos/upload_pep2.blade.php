...
<body>
               ...
               <div class="col-xs-12 col-sm-12 col-lg-12">
                  <div class="card">
                     <div class="card-header">
                        <strong>Upload Pep Nível 2</strong>
                     </div>
                     <div class="card-body card-block ">
                        <div class="form-group col-lg-7 " id="quadro_status">
                           Escolha um arquivo csv para fazer a atualização do PEP
                           ...
                           <small class="exemplo_base form-text text-muted">
                            <a href="{{ URL::asset('exemplos_base/exemplo_base_pep.csv')}}"><strong><i class="menu-icon fa fa-file-excel-o"></i> - Ver exemplo de base</strong></small></a>
                        </div>
                        ...
                        <div class="card-body col-lg-12"  id="resultado_importacao">
                                ...
                                <button onclick="abre_importados()" type="button" class=" info_button_importacao btn btn-success off m-l-10 m-b-10 col-lg-3 "><span class="badge badge-light" id="quantidade_sucesso">0</span> - Importados <i class="fa fa-search-plus"></i></button>
                                </br>
                                <div class="form-group  alert alert-success col-lg-11 col-sm-9" role="alert" id="lista_importados"></div>
                                <button  onclick="abre_atualizados()"  type="button" class=" info_button_importacao btn btn-info m-l-10 m-b-10 col-lg-3"><span  class="badge badge-light" id="quantidade_atualizado">0</span> - Atualizados  <i class="fa fa-search-plus"></i></button>
   ...
   <script src="{{ URL::asset('js/js_pep/upload_pep.js')}}"></script>
   <!-- footer do layout -->
