...
<html lang="en">
    ...
    margin: 10px;}
        ...
        <!-- load Galleria -->
        <script src="album_familia/galeria/src/galleria.js"></script>
...
<body>
    <div class="content">
        ...
        <p class="baixar_fotos" style='display: none'><a href="baixar_zip.php?pasta_fotos=<?php echo $_GET['pasta_fotos']; ?>"><img src='./album_familia/galeria/src/icone_baixar.ico' width="20"> Baixar as Fotos</a> </p>
        <div class="galleria">
            <?php
 ...
 $exif = exif_read_data("./album_familia/galeria/fotos/familia_batista/20200126_174723.jpg");
 print_r($exif);

 echo "<br>";


 $exif = exif_read_data("./album_familia/galeria/fotos/familia_batista/20200126_173956.jpg");
 print_r($exif);

 echo "<br>";

 $exif = exif_read_data("./album_familia/galeria/fotos/familia_batista/20200126_174037.jpg");
    print_r($exif);
            ...
            if($arquivo!='.' and $arquivo!='..' ){ 
             ...
             if( $numero_fotos  <=  $numero_fotos_maximo  and   $numero_fotos >= $numero_fotos_minimo  ){ 
                ...
                <a href="<?php echo $path.$arquivo ?>">
                    <img 
                        src="<?php echo correctImageOrientation("http://willianbatista.com.br/album_familia/galeria/fotos/".$_GET['pasta_fotos'].'/'.$arquivo) ?>",
    ...
    <div > <span style="font-size: 16px">Paginas -<span> 
        <?php   $paginacao_html='';
                $paginacao_atual=1; 
                $quantidade_paginas= (int)$numero_fotos/15+1 ;

    
                while ($quantidade_paginas>= $paginacao_atual) {
                    $numero_fotos_maximo = $paginacao_atual*15;
                    $numero_fotos_minimo = $numero_fotos_maximo-15;
    ...
    $(function() {
        ...
        Galleria.loadTheme('album_familia/galeria/galleria.folio.js');
