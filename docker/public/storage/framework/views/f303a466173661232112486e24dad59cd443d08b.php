    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="<?php echo e(URL::asset('imagens/logo.png')); ?>" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="<?php echo e(URL::asset('imagens/logo2.png')); ?>" alt="Logo"></a>
            </div>
        ...
        <!-- Left Panel -->
        <!-- Right Panel --><?php /**PATH /var/www/public/laravel_site_wbatista/resources/views/base_layout/menu.blade.php ENDPATH**/ ?>